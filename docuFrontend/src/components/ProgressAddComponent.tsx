...
const ProgressAddComponent = () => {
    ...
    const addProgress = async (e) => {
        ...
        try {
            ...
            await axios.post(
                `${config.apiUrl}/admin/progress/createProgress`, 
                {
                    name: progressName,
                    color: progressColor,
                },
            ...
            navigate('/progresos', { state: { successMessage: 'Dato agregado correctamente.' } });
        } catch (error) {
...
export default ProgressAddComponent;
